...
import sklearn
from sklearn.metrics import adjusted_rand_scoreproduct_descriptions.shape
from sklearn.metrics import adjusted_rand_scoreproduct_descriptions = pd.read_csv(
    '../input/home-depot-product-search-relevance/product_descriptions.csv')
